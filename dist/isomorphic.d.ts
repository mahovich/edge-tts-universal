...
export { IsomorphicCommunicate as Communicate, type IsomorphicCommunicateOptions as CommunicateOptions, type CommunicateState, IsomorphicDRM as DRM, IsomorphicEdgeTTS as EdgeTTS, EdgeTTSException, FetchError, NoAudioReceived, type ProsodyOptions, SkewAdjustmentError, SubMaker, type SynthesisResult, type TTSChunk, UnexpectedResponse, IsomorphicCommunicate as UniversalCommunicate, type IsomorphicCommunicateOptions as UniversalCommunicateOptions, IsomorphicDRM as UniversalDRM, IsomorphicEdgeTTS as UniversalEdgeTTS, FetchError as UniversalFetchError, IsomorphicVoicesManager as UniversalVoicesManager, UnknownResponse, ValueError, type Voice, type VoiceTag, IsomorphicVoicesManager as VoicesManager, type VoicesManagerFind, type VoicesManagerVoice, WebSocketError, type WordBoundary, createSRT, createVTT, listVoices, listVoices as listVoicesUniversal };
